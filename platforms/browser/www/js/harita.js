function harita() {
    ...
    this.yerTakipEt = function (deviceInfo) {
        var options = {maximumAge: 0, timeout: 10000, enableHighAccuracy: true};
        var successCallback = cihazinPozisyonDegisti(deviceInfo);
        navigator.geolocation.watchPosition(successCallback, yerTakipEdilememeDurumu, options);
    };
    ...
    this.yerBildir = function () {
        ...
        var cihazYerBilgileri = {
            ...
            anlikPozisyonList: bildirilemeyenPozisyonGecmisiniGetir()
        };
    ...
    function cihazinPozisyonDegisti(deviceInfo) {
